...
try {
    $querySport = "SELECT s.nom_sport FROM SPORT s WHERE id_sport = :idSport";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $queryCheck = "SELECT s.id_sport FROM SPORT s WHERE nom_sport = :nomSport AND id_sport <> :idSport";
