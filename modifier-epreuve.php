...
try {
    $queryEpreuve = "SELECT e.nom_epreuve, e.date_epreuve, e.heure_epreuve, e.id_lieu, e.id_sport FROM EPREUVE e WHERE id_epreuve = :idEpreuve";
    ...
    $queryLieux = "SELECT l.id_lieu, l.nom_lieu FROM LIEU l";
    ...
    $querySports = "SELECT s.id_sport, s.nom_sport FROM SPORT s";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $queryCheck = "SELECT e.id_epreuve FROM EPREUVE e WHERE nom_epreuve = :nom_epreuve AND date_epreuve = :date_epreuve AND id_epreuve <> :id_epreuve";
