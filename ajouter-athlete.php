...
$sqlGenres = "SELECT g.id_genre, g.nom_genre FROM GENRE g";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $queryCheck = "SELECT a.id_athlete FROM ATHLETE a WHERE nom_athlete = :nom_athlete AND prenom_athlete = :prenom_athlete";
