...
$sqlAthletes = "SELECT a.id_athlete, a.nom_athlete, a.prenom_athlete FROM ATHLETE a";
$stmtAthletes = $pdo->query($sqlAthletes);
$athletes = $stmtAthletes->fetchAll(PDO::FETCH_ASSOC);

// Récupérer toutes les épreuves
$sqlEpreuves = "SELECT e.id_epreuve, e.nom_epreuve FROM EPREUVE e"; // Assurez-vous que la table epreuve existe
...
$sqlPays = "SELECT y.id_pays, y.nom_pays FROM PAYS y";
