...
try {
    $queryGenre = "SELECT g.nom_genre FROM GENRE g WHERE id_genre = :idGenre";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $queryCheck = "SELECT g.id_genre FROM GENRE g WHERE nom_genre = :nomGenre AND id_genre <> :idGenre";
