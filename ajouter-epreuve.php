...
$sqlLieux = "SELECT l.id_lieu, l.nom_lieu FROM LIEU l";
$stmtLieux = $pdo->query($sqlLieux);
$lieux = $stmtLieux->fetchAll(PDO::FETCH_ASSOC);

$sqlSports = "SELECT s.id_sport, s.nom_sport FROM SPORT s";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $queryCheck = "SELECT e.id_epreuve FROM EPREUVE e WHERE nom_epreuve = :nom_epreuve AND date_epreuve = :date_epreuve";
